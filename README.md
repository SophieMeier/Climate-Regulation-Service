...
The Zensus-raster was converted to vector format (grid) by two steps in ArcGIS: 1) Raster to Point, 2) Create Fishnet with and use Points-Features created in 1) as labels. 
